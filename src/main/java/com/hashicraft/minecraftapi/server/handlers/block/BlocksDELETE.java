...
public class BlocksDELETE implements Handler {
  ...
  @OpenApi(path = "/v1/block/{start x}/{start y}/{start z}/{end x}/{end y}/{end z}", // only necessary to include when
                                                                                     // using static method references
      methods = HttpMethod.DELETE, summary = "Delete multiple blocks", description = "Deletes the blocks at the given location", operationId = "deleteMultipleBlocks", tags = {
          "Block" }, pathParams = {
  ...
  public void handle(Context ctx) throws Exception {
    ...
    LOGGER.info("Blocks DELETE called start_x:{}, start_y:{}, start_z:{} end_x:{}, end_y:{}, end_z:{}", startX, startY,
