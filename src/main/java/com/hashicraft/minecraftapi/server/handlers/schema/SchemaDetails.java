...
public class SchemaDetails implements Handler {
  ...
  @OpenApi(
      path = "/v1/schema/details/{id}",
      methods = HttpMethod.GET,    
      summary = "Get the details of a schema",
      description = "This method allows you to fetch the details of an applied schema single block for the given id. If no schema exists at the coordinates, a 404 is returned",
  ...
  public void handle(Context ctx) throws Exception {
    ...
    Vec3d startPos = Util.getStartPosFromBlocks(blocks);
    Vec3d endPos = Util.getEndPosFromBlocks(blocks);
